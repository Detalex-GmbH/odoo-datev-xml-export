Open the **Invoicing** app or any other app and go to **Configuration > Settings**. Search for **DATEV** or find at the **Invoicing** page the **DATEV XML Export** section.
...
If set, the invoices are marked as exported when finishing a Datev XML export. Only not yet exported invoices are suggested for next Datev XML export.
