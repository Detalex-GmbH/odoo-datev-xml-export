...
**Invoicing > Reporting > Datev XML Export**.
...
If you create a manual export from the vendor bills list the export type is „Incoming“. If you create this export from the customer invoices the export type is „Outgoing“.
...
Contact Detalex GmbH for further information and support.
...
This module is maintained by Detalex GmbH.

.. image:: https://detalex.de/web/image/website/1/logo/Detalex%20GmbH?unique=d253608
     :alt: Detalex GmbH
     :target: https://detalex.com
